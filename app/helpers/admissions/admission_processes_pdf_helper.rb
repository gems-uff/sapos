...
module Admissions::AdmissionProcessesPdfHelper
  ...
  def admission_process_pdf_title(admission_process)
    [
      ...
      ["<b>#{admission_process_pdf_t("generic.start", date: date_br(admission_process.start_date))}
        #{admission_process_pdf_t('generic.end', date: date_br(admission_process.end_date))}
