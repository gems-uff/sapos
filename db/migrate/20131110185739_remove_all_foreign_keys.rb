...
class RemoveAllForeignKeys < ActiveRecord::Migration[5.1]
  def up
    ...
    execute "INSERT INTO
      states_temp(id,name,code,country_id,created_at,updated_at)
    ...
    execute "INSERT INTO students_temp(
        id,name,cpf,created_at,updated_at,obs,birthdate,sex,civil_status,
        father_name,mother_name,country_id,birthplace,identity_number,
        identity_issuing_body,identity_expedition_date,employer,job_position,
        state_id,city_id,neighbourhood,zip_code,address,telephone1,telephone2,
        email
      )
      SELECT
        id,name,cpf,created_at,updated_at,obs,birthdate,sex,civil_status,
    ...
    execute "INSERT INTO enrollments_temp(
        id,enrollment_number,student_id,level_id,enrollment_status_id,
        admission_date,obs,created_at,updated_at,thesis_title
      )
      SELECT
        id,enrollment_number,student_id,level_id,enrollment_status_id,
        admission_date,obs,created_at,updated_at,thesis_title
    ...
    execute "INSERT INTO accomplishments_temp(
        id,enrollment_id,phase_id,conclusion_date,obs,created_at,updated_at
      )
      SELECT
        id,enrollment_id,phase_id,conclusion_date,obs,created_at,updated_at
    ...
    execute "INSERT INTO professors_temp(
        id,name,cpf,birthdate,created_at,updated_at,sex,civil_status,
        identity_number,identity_issuing_body,identity_expedition_date,
        neighbourhood,address,state_id,city_id,zip_code,telephone1,telephone2,
        siape,enrollment_number
      )
      SELECT
        id,name,cpf,birthdate,created_at,updated_at,sex,civil_status,
        identity_number,identity_issuing_body,identity_expedition_date,
    ...
    execute "INSERT INTO advisement_authorizations_temp(
        id,professor_id,level_id,created_at,updated_at
      )
      SELECT
        id,professor_id,level_id,created_at,updated_at
    ...
    execute "INSERT INTO advisements_temp(
        id,professor_id,enrollment_id,main_advisor,created_at,updated_at
      )
      SELECT
        id,professor_id,enrollment_id,main_advisor,created_at,updated_at
      FROM advisements"
    ...
    execute "INSERT INTO courses_temp(
        id,name,code,content,credits,research_area_id,course_type_id,
    ...
    execute "INSERT INTO course_classes_temp(
        id,name,course_id,professor_id,year,semester,created_at,updated_at
      )
      SELECT
        id,name,course_id,professor_id,year,semester,created_at,updated_at
      FROM course_classes"
    ...
    execute "INSERT INTO allocations_temp(
        id,day,room,start_time,end_time,course_class_id,created_at,updated_at
      )
      SELECT
        id,day,room,start_time,end_time,course_class_id,created_at,updated_at
      FROM allocations"
    ...
    execute "INSERT INTO class_enrollments_temp(
        id,obs,grade,situation,course_class_id,enrollment_id,
        created_at,updated_at,disapproved_by_absence
      )
      SELECT
        id,obs,grade,situation,course_class_id,enrollment_id,
        created_at,updated_at,disapproved_by_absence
    ...
    execute "INSERT INTO deferral_types_temp(
        id,name,description,duration_semesters,phase_id,created_at,
        updated_at,duration_months,duration_days
      )
      SELECT
        id,name,description,duration_semesters,phase_id,created_at,
        updated_at,duration_months,duration_days
    ...
    execute "INSERT INTO deferrals_temp(
        id,approval_date,obs,enrollment_id,deferral_type_id,
        created_at,updated_at
      )
      SELECT
        id,approval_date,obs,enrollment_id,deferral_type_id,
    ...
    execute "INSERT INTO dismissals_temp(
        id,date,enrollment_id,dismissal_reason_id,obs,created_at,updated_at
      )
      SELECT
        id,date,enrollment_id,dismissal_reason_id,obs,created_at,updated_at
      FROM dismissals"
    ...
    execute "INSERT INTO majors_temp(
        id,name,level_id,institution_id,created_at,updated_at
      )
      SELECT
        id,name,level_id,institution_id,created_at,updated_at
      FROM majors"
    ...
    execute "INSERT INTO phase_durations_temp(
        id,phase_id,level_id,deadline_semesters,created_at,updated_at,
        deadline_months,deadline_days
      )
      SELECT
        id,phase_id,level_id,deadline_semesters,created_at,updated_at,
        deadline_months,deadline_days
    ...
    execute "INSERT INTO professor_research_areas_temp(
        id,professor_id,research_area_id,created_at,updated_at
      )
      SELECT
        id,professor_id,research_area_id,created_at,updated_at
      FROM professor_research_areas"
    ...
    execute "INSERT INTO scholarships_temp(
        id,scholarship_number,level_id,sponsor_id,scholarship_type_id,
        start_date,end_date,obs,created_at,updated_at,professor_id
      )
      SELECT
        id,scholarship_number,level_id,sponsor_id,scholarship_type_id,
        start_date,end_date,obs,created_at,updated_at,professor_id
    ...
    execute "INSERT INTO scholarship_durations_temp(
        id,scholarship_id,enrollment_id,start_date,end_date,obs,
        created_at,updated_at,cancel_date
      )
      SELECT
        id,scholarship_id,enrollment_id,start_date,end_date,obs,
        created_at,updated_at,cancel_date
    ...
    execute "INSERT INTO users_temp(
        id,name,hashed_password,salt,created_at,updated_at,email,
        encrypted_password,reset_password_token,reset_password_sent_at,
        remember_created_at,sign_in_count,current_sign_in_at,last_sign_in_at,
        current_sign_in_ip,last_sign_in_ip,confirmation_token,confirmed_at,
        confirmation_sent_at,failed_attempts,unlock_token,locked_at,role_id
      )
      SELECT
        id,name,hashed_password,salt,created_at,updated_at,email,
        encrypted_password,reset_password_token,reset_password_sent_at,
