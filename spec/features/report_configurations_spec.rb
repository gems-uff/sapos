  ...
  describe "view list page" do
    ...
    it "should show table" do
      ...
      expect(page.all("tr th").map(&:text)).to eq [
          "Nome", "Prioridade", "Header", "Tipo de Assinatura", "Usar em declarações", "Usar em relatórios", "Usar no histórico", "Usar no boletim", "Usar no quadro de horários", "Validade (meses)", ""
      ]
    end
