...
RSpec.describe EnrollmentRequest, type: :model do
  ...
  describe 'Main Scenario' do
    ...
    describe 'Methods' do
      ...
      describe 'status' do
        before(:each) do
          @destroy_later << course2 =  FactoryBot.create(:course_class)
      ...
      describe 'student_change!' do
        it 'should update both the last_student_change_at and the student_view_at attributes' do
          ...
          expect(enrollment_request.last_student_change_at).to eq(time)
          expect(enrollment_request.student_view_at).to eq(time)
        end
      end
      ...
      describe 'assign_course_class_ids and save_request' do
        before(:each) do
          ...
          @destroy_later << @course_class3 = FactoryBot.create(:course_class)
        ...
        context 'class schedule restrictions' do
          before(:each) do
            @destroy_later << @course_class4 = FactoryBot.create(:course_class)
            @destroy_later << @course_class5 = FactoryBot.create(:course_class)
            @destroy_later << @course_class6 = FactoryBot.create(:course_class)
            @destroy_later << @course_class7 = FactoryBot.create(:course_class)
            @destroy_later << @course_class8 = FactoryBot.create(:course_class)
            @destroy_later << @course_class9 = FactoryBot.create(:course_class)
  ...
  describe 'Scenario 2: filled database' do
    before(:all) do
      @destroy_scenario = [] 
      @destroy_scenario << enrollment1 = FactoryBot.create(:enrollment)
      @destroy_scenario << enrollment2 = FactoryBot.create(:enrollment)
      @destroy_scenario << enrollment3 = FactoryBot.create(:enrollment)
      ...
      @destroy_scenario << course_class1 = FactoryBot.create(:course_class)
      @destroy_scenario << course_class2 = FactoryBot.create(:course_class)
