class AddNewCustomVariables < ActiveRecord::Migration[5.1]
  def change
    ...
    CustomVariable.where(:variable => "grade_of_disapproval_for_absence").first or CustomVariable.create(:description=>"Nota de reprovação por falta", :variable =>"grade_of_disapproval_for_absence", :value => "0.0")
