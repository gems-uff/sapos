...
class NotificationsController < ApplicationController
  ...
  def permit_notification_params
    params[:notification_params].permit! unless
      params[:notification_params].nil?
  end
  ...
  active_scaffold :"notification" do |config|
    ...
    form_columns = [
      ...
      :notification_params, :individual, :has_grades_report_pdf_attachment,
  ...
  def execute_now
    process_action_link_action do |notification|
      ...
      notification_params = notification_params.to_unsafe_h if
        notification_params.is_a?(ActionController::Parameters)

      notification_execute = notification.execute(
  ...
  def notify
    ...
    Notifier.send_emails({
      notifications: notifications_flatten,
