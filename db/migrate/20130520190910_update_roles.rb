  ...
  def self.down
    Role.transaction do
      [
        { id: 1, name: "Desconhecido", description: "Desconhecido" },
        { id: 2, name: "Coordenação", description: "Coordenação" },
        { id: 3, name: "Secretaria de bolsas",
          description: "Secretaria de bolsas" },
        { id: 4, name: "Secretaria de matrículas",
          description: "Secretaria de matrículas" },
        { id: 5, name: "Secretaria de Manutenção de Matrícula",
          description: "Secretaria de Manutenção de Matrícula" },
