...
class Admissions::FormTemplatesController < ApplicationController
  ...
  def populate_field
    ...
    attribute_configs = [
      ...
      { name: I18n.t("active_scaffold.admissions/form_template.generate_fields.obs_refugee"),
        field_type: Admissions::FormField::STUDENT_FIELD,
        configuration: JSON.dump({ "field": "obs_refugee", "required": true }) },
      ...
      { name: I18n.t("active_scaffold.admissions/form_template.generate_fields.obs_pcd"),
        field_type: Admissions::FormField::STUDENT_FIELD,
        configuration: JSON.dump({ "field": "obs_pcd", "required": true }) },
