...
#Student can not be configured as record select because it does not allow the user to create a new one, if needed
    ...
    config.create.columns = [:enrollment_number, :admission_date, :level, :enrollment_status, :obs, :student, :thesis_title, :thesis_defense_date, :advisements, :scholarship_durations, :dismissal, :class_enrollments]
    config.update.columns = [:enrollment_number, :admission_date, :level, :enrollment_status, :obs, :student, :thesis_title, :thesis_defense_date, :advisements, :accomplishments, :deferrals, :scholarship_durations, :dismissal, :class_enrollments]
