...
RSpec.describe "Pendencies features", type: :feature do
  ...
  before(:all) do
    ...
    @destroy_all << @course_class2 = FactoryBot.create(:course_class, name: "Algebra", course: @course1, professors: [@professor1], year: YearSemester.current.year, semester: YearSemester.current.semester)
    ...
    @destroy_all << @course_class4 = FactoryBot.create(:course_class, name: "Versionamento", course: @course3, professors: [@professor2], year: YearSemester.current.year, semester: YearSemester.current.semester)
    @destroy_all << @course_class5 = FactoryBot.create(:course_class, name: "Defesa", course: @course4, professors: [@professor3], year: YearSemester.current.year, semester: YearSemester.current.semester)
    @destroy_all << @course_class6 = FactoryBot.create(:course_class, name: "Mineração de Repositórios", course: @course5, professors: [@professor2], year: YearSemester.current.year, semester: YearSemester.current.semester)
    @destroy_all << @course_class7 = FactoryBot.create(:course_class, name: "Pesquisa", course: @course6, professors: [@professor3], year: YearSemester.current.year, semester: YearSemester.current.semester)
    @destroy_all << @course_class8 = FactoryBot.create(:course_class, name: "Programação", course: @course7, professors: [@professor1], year: YearSemester.current.year, semester: YearSemester.current.semester)
