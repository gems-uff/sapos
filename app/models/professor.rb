...
class Professor < ApplicationRecord
  ...
  has_many :course_class_professors, dependent: :restrict_with_exception
  has_many :course_classes, dependent: :restrict_with_exception, through: :course_class_professors
