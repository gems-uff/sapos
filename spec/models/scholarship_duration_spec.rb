    ...
    describe "enrollment" do
      context "should be valid when" do
        it "enrollment is not null and scholarship is not with another student" do
          scholarship_duration.scholarship = FactoryBot.create(:scholarship)
      ...
      context "should have error taken when" do
        it "enrollment has other active scholarship" do
          ...
          scholarship = FactoryBot.create(:scholarship, :start_date => start_date, :end_date => end_date)

          FactoryBot.create(:scholarship_duration, :enrollment => enrollment, :scholarship => scholarship, :start_date => start_date, :end_date => end_date)
    ...
    describe "if_scholarship_is_not_with_another_student" do
      context "should return the expected error when" do
        it "has an old scholarship that ends after the new scholarship starts" do
          enrollment = FactoryBot.create(:enrollment)
          scholarship = FactoryBot.create(:scholarship, :start_date => start_date, :end_date => end_date + 2.days)
          FactoryBot.create(:scholarship_duration, :enrollment => enrollment, :scholarship => scholarship,
        ...
        it "has an new scholarship that starts before the scholarship ends" do
          enrollment = FactoryBot.create(:enrollment)
          scholarship = FactoryBot.create(:scholarship, :start_date => end_date, :end_date => end_date + 2.days)
          FactoryBot.create(:scholarship_duration, :enrollment => enrollment, :scholarship => scholarship,
  ...
  describe "Methods" do
    describe "student_has_other_scholarship_duration" do
      context "should return true when" do
        it "has an old scholarship that ends after the new scholarship starts" do
          ...
          FactoryBot.create(:scholarship_duration, :enrollment => enrollment, :scholarship => scholarship,
                             :start_date => start_date, :end_date => end_date + 2.days)
          scholarship_duration.scholarship = FactoryBot.create(:scholarship, :start_date => end_date, :end_date => end_date + 5.days)
          scholarship_duration.start_date = end_date
          scholarship_duration.end_date = end_date + 5.days
          scholarship_duration.enrollment = enrollment
        ...
        it "has an new scholarship that starts before the scholarship ends" do
          ...
          FactoryBot.create(:scholarship_duration, :enrollment => enrollment, :scholarship => scholarship,
                             :start_date => end_date, :end_date => end_date + 2.days)
          scholarship_duration.scholarship = FactoryBot.create(:scholarship, :start_date => start_date, :end_date => end_date + 1.day)
          scholarship_duration.start_date = start_date
          scholarship_duration.end_date = end_date + 1.day
          scholarship_duration.enrollment = enrollment
          expect(scholarship_duration.student_has_other_scholarship_duration).to be_truthy
        ...
        it "has an new scholarship that is canceled before the scholarship ends" do
          ...
          FactoryBot.create(:scholarship_duration, :enrollment => enrollment, :scholarship => scholarship,
                             :start_date => end_date, :end_date => end_date + 2.days)
          scholarship_duration.scholarship = FactoryBot.create(:scholarship, :start_date => start_date, :end_date => end_date + 2.days)
          scholarship_duration.start_date = start_date
          scholarship_duration.end_date = end_date + 2.days
          scholarship_duration.cancel_date = end_date + 1.day
          scholarship_duration.enrollment = enrollment
    ...
    describe "warning_message" do
      it "should return nil when everything is alright" do
        enrollment = FactoryBot.create(:enrollment)
        scholarship = FactoryBot.create(:scholarship, :start_date => end_date, :end_date => end_date + 5.days)
        FactoryBot.create(:scholarship_duration, :enrollment => enrollment, :scholarship => scholarship,
    ...
    describe 'last_date' do
      before(:all) do
        @scholarship = FactoryBot.create(:scholarship, :start_date => 3.days.from_now.to_date, :end_date => 3.days.from_now.to_date + 5.months)
      end


      it 'should return end_date.end_of_month if there is no cancel_date' do
        scholarship_duration = FactoryBot.create(:scholarship_duration, :start_date => end_date, :end_date => end_date + 2.months, :cancel_date => nil, :scholarship => @scholarship)
      ...
      it 'should return cancel_date.end_of_month if there is a cancel_date' do
        scholarship_duration = FactoryBot.create(:scholarship_duration, :start_date => end_date, :end_date => end_date + 2.months, :cancel_date => end_date + 1.months, :scholarship => @scholarship)
    ...
    describe 'was_cancelled?' do
      ...
      it 'should return false if cancel_date == end_date' do
        scholarship_duration = FactoryBot.create(:scholarship_duration, :start_date => end_date, :end_date => end_date + 2.months, :cancel_date => end_date + 2.months, :scholarship => @scholarship)
        expect(scholarship_duration.was_cancelled?).to eq(false)
      end
