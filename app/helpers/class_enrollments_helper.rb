...
module ClassEnrollmentsHelper
  ...
  alias_method :course_class_form_column, :custom_course_class_form_column
  alias_method :disapproved_by_absence_form_column, :custom_disapproved_by_absence_form_column
  alias_method :grade_form_column, :custom_grade_form_column
  alias_method :grade_not_count_in_gpr_form_column, :custom_grade_not_count_in_gpr_form_column
  alias_method :obs_form_column, :custom_obs_form_column
