    ...
    describe "enrollment" do
      context "should be valid when" do
        it "enrollment is not null" do
          ...
          enrollment_hold.should have(0).errors_on :enrollment
        end
      end
      context "should have error blank when" do
        it "enrollment is null" do
          enrollment_hold.enrollment = nil
          enrollment_hold.should have_error(:blank).on :enrollment
        end
      end
    end
    describe "number_of_semesters" do
      context "should be valid when" do
        it "it is greater than 0" do
          ...
          enrollment_hold.should have(0).errors_on :number_of_semesters
        end
      end
      context "should have error when" do
        it "it is lower than or equal to 0" do
          enrollment_hold.number_of_semesters = 0
          enrollment_hold.should have_error(:greater_than_or_equal_to).with_parameter(:count, 1).on :number_of_semesters
        end

        it "it is blank" do
          enrollment_hold.number_of_semesters = nil
          enrollment_hold.should have_error(:blank).on :number_of_semesters
        end
      end
    end
    describe "year" do
      context "should be valid when" do
        it "it is not null" do
          ...
          enrollment_hold.should have(0).errors_on :year
        end
      end
      context "should have error when" do
        it "it is blank" do
          enrollment_hold.year = nil
          enrollment_hold.should have_error(:blank).on :year
        end
      end
    end
    describe "semester" do
      context "should be valid when" do
        it "it is 1" do
          ...
          enrollment_hold.should have(0).errors_on :semester
        end
        it "it is 2" do
      ...
      context "should have error when" do
        it "it is blank" do
          ...
          enrollment_hold.should have_error(:blank).on :semester
        end
        it "it isnt 1 or 2" do
          enrollment_hold.semester = nil
          enrollment_hold.should have_error(:inclusion).on :semester
        end
      end
    end
    ...
    describe "base" do
      context "should have error when" do
        it "year-semester is before enrollment admission date" do
          ...
          enrollment_hold.semester = 1
          enrollment_hold.should have_error(:before_admission_date).on :base
        end
        ...
        it "year-semester is before enrollment admission date" do
          ...
          enrollment_hold.should have_error(:after_dismissal_date).on :base
        end
      end
    end
  end
  ...
  describe "Methods" do
    context "to_label" do
      it "should return the semester and the number of semesters" do
        ...
        enrollment_hold.to_label.should == "2014.1 - 2 semestres"
      end
    end
  end
